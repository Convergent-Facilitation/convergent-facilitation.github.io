...
excerpt: A new CF live coaching offering is launching in May 2025, to support dedicated practitioners, with real-life examples focused on facilitating across polarization.
    ...
    actions={[
	  {
        ...
        href: 'https://docs.google.com/forms/d/e/1FAIpQLSfUyd9x8wjZYpvCuRX5IAmlky3cYCW15cKhs9dl8pPXsEWPlA/viewform',
...
Questions? You can reach us at *support-2025-coaching-series [at] convergentfacilitation.org*. 

<CallToAction
	subtitle="If you would like to receive coaching or intend to participate in one of the role-plays please register by April 30th."
    actions={[
      { 
        variant: 'primary',
		text: 'Register here', 
        href: 'https://docs.google.com/forms/d/e/1FAIpQLSfUyd9x8wjZYpvCuRX5IAmlky3cYCW15cKhs9dl8pPXsEWPlA/viewform', icon: 'tabler:books',target: '_blank', 
	  },            
    ]}
  />
...
Roni's greatest passion is supporting people and groups of all sizes in making more collaborative decisions. They see this shift as essential for everyone's wellbeing and the future of life on this planet. Roni brings over 20 years of experience with facilitation, teaching, coaching, and leading systemic change. They draw on principles and practices from diverse frameworks, including Nonviolent Communication (NVC), Convergent Facilitation, Deep Democracy, Sociocracy, Reinventing Organizations, Theory U, and Open Floor. Their teaching and leadership style invites everyone to connect with their own wisdom, learn by doing, and work together to transform leadership and collaboration.

Find out more: https://sundragonrising.com/

### Verene Nicolas
![image verene](~/assets/images/verene_nicolas.jpg)
Verene is an experienced facilitator and certified trainer in Nonviolent Communication. She has delivered training and facilitated group decisions in many grassroots contexts. Her immersion in the Nonviolent Global Liberation (NGL) community where Convergent Facilitation is practiced daily gives her a deep grounding in the power of this approach to sustain ‘radical collaboration’ across differences of all sorts.
